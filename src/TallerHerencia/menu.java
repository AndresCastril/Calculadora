...
public class menu {
    ...
    public void mostrar() {
        ...
        JButton opcion1 = new JButton("1. Agregar empleado");
        JButton opcion2 = new JButton("2. Listar informacion de los empleados por horas");
        JButton opcion3 = new JButton("3. Listar informacion de los empleados por sueldo");
        JButton opcion4 = new JButton("4. Listar informacion de los empleados gerentes");
